...
#if defined(NDEBUG)
# error "Blazecoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Blazecoin Signed Message:\n";
...
CAmount GetBlockValue(int nHeight, const CAmount& nFees)
{
    ...
    // Subsidy is cut in half every 1,051,200 blocks which will occur approximately every 1 years.
    nSubsidy >>= halvings;
...
void ThreadScriptCheck() {
    RenameThread("blazecoin-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Blazecoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Blazecoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
