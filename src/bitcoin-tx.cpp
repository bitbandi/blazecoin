...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Blazecoin Core blazecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  blazecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blazecoin transaction") + "\n" +
              "  blazecoin-tx [options] -create [commands]   " + _("Create hex-encoded blazecoin transaction") + "\n" +
              "\n";
