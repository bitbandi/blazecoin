...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Blazecoin address (e.g. %1)").arg("BoQncybu3yMRCECd5241j324yKoV2XYNVK"));
#endif
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("blazecoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "blazecoin:");
    }
...
{
    QString ret = QString("blazecoin:%1").arg(info.address);
    int paramCount = 0;
