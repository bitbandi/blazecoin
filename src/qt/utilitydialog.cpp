    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Blazecoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Blazecoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Blazecoin Core is shutting down...") + "<br /><br />" +
