...
#else
    const char* pszModule = "blazecoin";
#endif
    if (pex)
        return strprintf(
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "blazecoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override blazecoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "blazecoind.pid"));
